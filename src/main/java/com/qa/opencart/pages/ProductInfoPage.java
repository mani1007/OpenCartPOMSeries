...
public class ProductInfoPage {
	...
	{
		int totalImages = eleUtil.WaitUntilElementsVisibility(images, 10).size();
		//System.out.println("Product Images Count: "+ totalImages);
		Log.info("Product Images Count: "+ totalImages);
		return totalImages;
	}
